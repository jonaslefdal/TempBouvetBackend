...
namespace BouvetBackend.Migrations
{
    ...
    [Migration("20250424130604_AddEndUserAddressTable")]
    partial class AddEndUserAddressTable
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BouvetBackend.Entities.EndUserAddress", b =>
                {
                    b.Property<int>("EndUserAddressId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");

                    NpgsqlPropertyBuilderExtensions.UseIdentityByDefaultColumn(b.Property<int>("EndUserAddressId"));
                    ...
                    b.HasKey("EndUserAddressId");

                    b.ToTable("enduseraddress", (string)null);
                });
